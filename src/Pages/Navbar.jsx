  ...
  return (
    <header className="fixed top-0 w-full bg-gray-800 text-white z-50">
      <nav className="container mx-auto flex justify-between items-center p-5">
        <div className="logo">
          <span className="text-xl font-bold">X-CUBETECHNOLOGY</span>
        </div>
        ...
        <div className="hidden lg:flex space-x-4">
          <a href="https://web.facebook.com/XCUBEAdvertising/?_rdc=1&_rdr" target="_blank" rel="noopener noreferrer" className="text-white hover:text-red-500"><FaFacebook size={24} /></a>
          <a href="https://www.instagram.com/x_cuberwanda/?hl=en" target="_blank" rel="noopener noreferrer" className="text-white hover:text-red-500"><FaInstagram size={24} /></a>
          <a href="https://www.youtube.com/channel/UC53mkUIjqaxruafpZk5n93Q" target="_blank" rel="noopener noreferrer" className="text-white hover:text-red-500"><FaYoutube size={24} /></a>
          <a href="https://rw.linkedin.com/in/x-cube-rwanda-aa015720a" target="_blank" rel="noopener noreferrer" className="text-white hover:text-red-500"><FaLinkedin size={24} /></a>
        </div>
